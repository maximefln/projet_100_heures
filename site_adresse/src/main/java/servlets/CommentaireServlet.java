...
public class CommentaireServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Commentaire> commentairelist = CommentaireLibrary.getInstance().listCommentaire();

        context.setVariable("listCommentaire", commentairelist);

        engine.process("commentaire", context, resp.getWriter());
